...
static const char qt_meta_stringdata_UserProfile[] = {
    "UserProfile\0\0clickEditUser()\0"
};
...
const QMetaObjectExtraData UserProfile::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject UserProfile::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_UserProfile,
      qt_meta_data_UserProfile, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &UserProfile::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_UserProfile))
