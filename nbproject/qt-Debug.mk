...
# Generated by qmake (2.01a) (Qt 4.8.6) on: Thu Apr 30 20:36:05 2015
...
$(TARGET): ui_Home.h ui_Project.h $(OBJECTS)  
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) build/Debug/GNU-Linux-x86/3111.0.0/ && $(COPY_FILE) --parents Home.h Project.h build/Debug/GNU-Linux-x86/3111.0.0/ && $(COPY_FILE) --parents Home.cpp Project.cpp main.cpp build/Debug/GNU-Linux-x86/3111.0.0/ && $(COPY_FILE) --parents Home.ui Project.ui build/Debug/GNU-Linux-x86/3111.0.0/ && (cd `dirname build/Debug/GNU-Linux-x86/3111.0.0` && $(TAR) 3111.0.0.tar 3111.0.0 && $(COMPRESS) 3111.0.0.tar) && $(MOVE) `dirname build/Debug/GNU-Linux-x86/3111.0.0`/3111.0.0.tar.gz . && $(DEL_FILE) -r build/Debug/GNU-Linux-x86/3111.0.0
...
compiler_moc_header_make_all: moc_Home.cpp moc_Project.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_Home.cpp moc_Project.cpp
...
compiler_uic_make_all: ui_Home.h ui_Project.h
compiler_uic_clean:
	-$(DEL_FILE) ui_Home.h ui_Project.h
ui_Home.h: Home.ui
