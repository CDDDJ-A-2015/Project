...
# Generated by qmake (2.01a) (Qt 4.8.6) on: Thu May 21 18:11:30 2015
...
OBJECTS       = build/Debug/GNU-Linux-x86/Coco1.o \
		...
		build/Debug/GNU-Linux-x86/apn.o \
...
$(TARGET): ui_Coco1.h ui_Coco2.h ui_EditProject.h ui_EditTask.h ui_EditUser.h ui_FuncPoints.h ui_Home.h ui_Login.h ui_Project.h ui_Search.h ui_StringDialog.h ui_Task.h ui_UserProfile.h ui_displayGraphics.h ui_searchResults.h $(OBJECTS)  
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) build/Debug/GNU-Linux-x86/3111.0.0/ && $(COPY_FILE) --parents Client_Side.h Coco1.h Coco2.h EditProject.h EditTask.h EditUser.h FuncPoints.h Home.h Login.h Packets.h Project.h Search.h StringDialog.h Task.h UserProfile.h apn.h displayGraphics.h searchResults.h build/Debug/GNU-Linux-x86/3111.0.0/ && $(COPY_FILE) --parents Coco1.cpp Coco2.cpp EditProject.cpp EditTask.cpp EditUser.cpp FuncPoints.cpp Home.cpp Login.cpp Project.cpp Search.cpp StringDialog.cpp Task.cpp UserProfile.cpp apn.cpp displayGraphics.cpp main.cpp searchResults.cpp build/Debug/GNU-Linux-x86/3111.0.0/ && $(COPY_FILE) --parents Coco1.ui Coco2.ui EditProject.ui EditTask.ui EditUser.ui FuncPoints.ui Home.ui Login.ui Project.ui Search.ui StringDialog.ui Task.ui UserProfile.ui displayGraphics.ui searchResults.ui build/Debug/GNU-Linux-x86/3111.0.0/ && (cd `dirname build/Debug/GNU-Linux-x86/3111.0.0` && $(TAR) 3111.0.0.tar 3111.0.0 && $(COMPRESS) 3111.0.0.tar) && $(MOVE) `dirname build/Debug/GNU-Linux-x86/3111.0.0`/3111.0.0.tar.gz . && $(DEL_FILE) -r build/Debug/GNU-Linux-x86/3111.0.0
...
compiler_uic_make_all: ui_Coco1.h ui_Coco2.h ui_EditProject.h ui_EditTask.h ui_EditUser.h ui_FuncPoints.h ui_Home.h ui_Login.h ui_Project.h ui_Search.h ui_StringDialog.h ui_Task.h ui_UserProfile.h ui_displayGraphics.h ui_searchResults.h
compiler_uic_clean:
	-$(DEL_FILE) ui_Coco1.h ui_Coco2.h ui_EditProject.h ui_EditTask.h ui_EditUser.h ui_FuncPoints.h ui_Home.h ui_Login.h ui_Project.h ui_Search.h ui_StringDialog.h ui_Task.h ui_UserProfile.h ui_displayGraphics.h ui_searchResults.h
ui_Coco1.h: Coco1.ui
...
build/Debug/GNU-Linux-x86/apn.o: apn.cpp apn.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/Debug/GNU-Linux-x86/apn.o apn.cpp
